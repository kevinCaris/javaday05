...
public class Animal {
    ...
    public static void main(String[] args) {
        ...
        Animal nemo = new Animal("Nemo", 0, Animal.FISH);
        Animal tweety = new Animal("Tweety", 2, Animal.BIRD);
        System.out.println(isidore.getName() + " has " + isidore.getLegs() + " legs and is a " + isidore.getType() + ".");
        System.out.println(nemo.getName() + " has " + nemo.getLegs() + " legs and is a " + nemo.getType() + ".");
        System.out.println(tweety.getName() + " has " + tweety.getLegs() + " legs and is a " + tweety.getType() + ".");
